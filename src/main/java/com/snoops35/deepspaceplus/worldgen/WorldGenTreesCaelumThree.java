...
public class WorldGenTreesCaelumThree extends WorldGenAbstractTree
{
    ...
    private IBlockState LEAF = BlockInit.CAELUM_LEAF_THREE.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    private final int minTreeHeight = 7;

    public WorldGenTreesCaelumThree(boolean notify) {
        super(notify);
    }
